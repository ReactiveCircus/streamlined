...
object versions {
    ...
    object androidx {
        ...
        object test {
            const val core = "1.3.0-alpha05"
            const val monitor = "1.3.0-alpha05"
            const val rules = "1.3.0-alpha05"
            const val runner = "1.3.0-alpha05"

            object ext {
                const val junit = "1.1.2-alpha05"
                const val truth = "1.3.0-alpha05"
            }
