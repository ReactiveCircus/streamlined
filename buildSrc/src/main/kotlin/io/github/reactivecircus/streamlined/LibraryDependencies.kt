...
object versions {
    const val kotlin = "1.3.70-eap-274"
    ...
    object androidx {
        ...
        object test {
            ...
            const val monitor = "1.3.0-alpha04"
            const val rules = "1.3.0-alpha04"
            const val runner = "1.3.0-alpha04"

            object ext {
                const val junit = "1.1.2-alpha04"
                const val truth = "1.3.0-alpha04"
            }
